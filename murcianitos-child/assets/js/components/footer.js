import logoSrc from '../../assets/logo/logoblanconew.webp';
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            <img src="${logoSrc}" alt="Murcianitos" class="footer-logo" />
          </div>
        ...
        <div class="footer-bottom">
          <p class="footer-copyright">© ${new Date().getFullYear()} Murcianitos. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  `;
