        ...
        <div class="products-grid" data-reveal="stagger">
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3804.webp" alt="Murcianito Clásico" class="card-image">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/img3798.webp" alt="Murcianito Ibérico" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3826.webp" alt="Murcianito Trufado" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Edición Cuaresma" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3804.webp" alt="Murcianito Queso de Cabra" class="card-image" style="filter: contrast(1.1);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/img3798.webp" alt="Murcianito Vegano" class="card-image" style="filter: saturate(1.2);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
    ...
    <section class="menu-category" id="dulces" style="background-color: var(--color-cream);">
      <div class="container">
        ...
        <div class="products-grid" data-reveal="stagger">
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Murcianito Chocolate" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Murcianito Cabello de Ángel" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Murcianito Crema" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Murcianito Pistacho" class="card-image" style="filter: hue-rotate(-30deg);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Murcianito Turrón" class="card-image" style="filter: brightness(1.1);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="./src/assets/img3825.webp" alt="Murcianito Lemon Pie" class="card-image" style="filter: contrast(1.2) saturate(1.5);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
      ...
      <div class="container">
        ...
        <div class="products-grid" data-reveal="stagger">
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/pack3box.webp" alt="Pack Degustación" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/pack6box.webp" alt="Pack La Cuadrilla" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="./src/assets/pack12box.webp" alt="Pack El Bando" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
