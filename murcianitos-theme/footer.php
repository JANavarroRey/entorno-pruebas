<?php
/**
 * footer.php — Tema Standalone Murcianitos
 *
 * Replica exacta del componente footer.js, adaptada a PHP.
 */
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <img src="<?php echo $theme_uri; ?>/assets/images/logo/logoblanconew.webp" alt="Murcianitos" class="footer-logo" />
      </div>
      ...
      <div class="footer-col">
        ...
        <nav class="footer-links">
          <a href="<?php echo home_url('/carta/'); ?>">Carta</a>
          <a href="<?php echo home_url('/nuestra-historia/'); ?>">Historia</a>
    ...
    <div class="footer-bottom">
      <p class="footer-copyright">© <?php echo date('Y'); ?> Murcianitos. Todos los derechos reservados.</p>
    </div>
  </div>
</footer>
