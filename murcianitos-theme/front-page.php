<?php
/**
 * front-page.php — Tema Standalone Murcianitos
 *
 * Replica EXACTA del cuerpo de index.html.
 * Cada <img src> apunta a get_template_directory_uri().
 * Los tickers se renderizan directamente en PHP (sin JS renderHeader/renderTicker).
 */
...
<main>
  ...
  <section class="hero-fullscreen">
    <img src="<?php echo $img; ?>/murcianitos.webp" alt="Murcianitos Fondo" class="hero-fullscreen-bg">
    <div class="hero-overlay"></div>

    <div class="hero-fullscreen-content" data-reveal="fade-up">
  ...
  <?php
  $ticker_burgundy_text = 'PASTEL DE CARNE MURCIANO <span class="ticker-separator"></span> HONRAMOS LA TRADICIÓN <span class="ticker-separator"></span> REINVENTAMOS EL SABOR <span class="ticker-separator"></span>';
  $ticker_burgundy_repeated = str_repeat($ticker_burgundy_text, 6);
  ?>
  <div class="ticker-section theme-burgundy">
    <div class="ticker-track">
      <div class="ticker-item"><?php echo $ticker_burgundy_repeated; ?></div>
      <div class="ticker-item"><?php echo $ticker_burgundy_repeated; ?></div>
    </div>
  </div>

  <!-- 3. About Section (Dark Mode) -->
  <section class="section theme-dark" style="background-color: var(--surface-dark);">
    <div class="container about-grid">
      <div class="about-image">
        <img src="<?php echo $img; ?>/obrador-tradicion.webp" alt="Artesano en un obrador tradicional" data-parallax="true">
      </div>
  ...
  <section class="section">
    <div class="container">
      <div style="text-align: center; max-width: 900px; margin: 0 auto;" data-reveal="fade-up">
        <span class="hero-label"
          style="color: var(--color-gold); font-family: var(--font-label); font-size: 0.75rem; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase;">Nuestros
          Favoritos</span>
      ...
      <div class="products-grid" data-reveal="stagger">
        ...
        <article class="card-product stagger-item">
          <div class="card-image-wrap">
            <img src="<?php echo $img; ?>/img3804.webp" alt="Murcianito Clásico" class="card-image">
        ...
        <article class="card-product stagger-item">
          ...
          <div class="card-image-wrap">
            <img src="<?php echo $img; ?>/img3798.webp" alt="Murcianito Ibérico" class="card-image">
            <div class="card-image-overlay"></div>
          </div>
          <div class="card-content">
        ...
        <article class="card-product stagger-item">
          ...
          <div class="card-image-wrap">
            <img src="<?php echo $img; ?>/pack6box.webp" alt="Pack La Cuadrilla" class="card-image">
            <div class="card-image-overlay"></div>
          </div>
          <div class="card-content">
        ...
        <article class="card-product stagger-item">
          ...
          <div class="card-image-wrap">
            <img src="<?php echo $img; ?>/pack12box.webp" alt="Pack El Bando" class="card-image">
            <div class="card-image-overlay"></div>
          </div>
          <div class="card-content">
        ...
        <article class="card-product stagger-item">
          <div class="card-image-wrap">
            <img src="<?php echo $img; ?>/img3826.webp" alt="Murcianito Trufado" class="card-image">
            <div class="card-image-overlay"></div>
          </div>
          <div class="card-content">
        ...
        <article class="card-product stagger-item">
          <div class="card-image-wrap">
            <img src="<?php echo $img; ?>/img3825.webp" alt="Edición Cuaresma" class="card-image">
            <div class="card-image-overlay"></div>
          </div>
          <div class="card-content">
  ...
  <?php
  $ticker_gold_text = 'TRADICIÓN <span class="ticker-separator"></span> ARTESANÍA <span class="ticker-separator"></span> SABOR <span class="ticker-separator"></span>';
  $ticker_gold_repeated = str_repeat($ticker_gold_text, 6);
  ?>
  <div class="ticker-section theme-gold">
    <div class="ticker-track">
      <div class="ticker-item"><?php echo $ticker_gold_repeated; ?></div>
      <div class="ticker-item"><?php echo $ticker_gold_repeated; ?></div>
    </div>
  </div>

  <!-- 6. Gifting Banner -->
  <section class="gifting-banner" data-reveal="fade-up">
    <img src="<?php echo $img; ?>/rusticmurcianitosbox.webp" alt="Regalo" class="gifting-bg" style="opacity: 0.4;">
    <div class="container" style="position: relative; z-index: 2; max-width: 800px; margin: 0 auto;">
      <span style="display: block; font-family: var(--font-label); font-size: 0.75rem; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase; color: var(--color-gold); margin-bottom: var(--space-md);">El
        Detalle Perfecto</span>
      <h2 style="font-size: clamp(2.5rem, 5vw, 4rem); margin: 0; line-height: 1.1; color: var(--color-white);">Comparte
        Historia,</h2>
  ...
  <section class="section">
    <div class="container">
      <div style="text-align: center; margin-bottom: var(--space-xl);" data-reveal="fade-up">
        <span class="hero-label"
          style="color: var(--color-gold); font-family: var(--font-label); font-size: 0.75rem; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase;">Únete
          al culto</span>
        <h2>@murcianitos_oficial</h2>
      </div>

      <div class="instagram-grid" data-reveal="stagger">
        <a href="https://www.instagram.com/murcianitos_oficial/" target="_blank" class="ig-item stagger-item">
          <img src="<?php echo $img; ?>/metro.webp" alt="Campaña Metro">
        </a>
        <a href="https://www.instagram.com/murcianitos_oficial/" target="_blank" class="ig-item stagger-item">
          <img src="<?php echo $img; ?>/cartel-gigante.webp" alt="Campaña Cartel Gigante">
        </a>
        <a href="https://www.instagram.com/murcianitos_oficial/" target="_blank" class="ig-item stagger-item">
          <img src="<?php echo $img; ?>/caballete.webp" alt="Campaña Caballete">
        </a>
        <a href="https://www.instagram.com/murcianitos_oficial/" target="_blank" class="ig-item stagger-item">
          <img src="<?php echo $img; ?>/lona-2.webp" alt="Campaña Lona">
        </a>
      </div>
    </div>
  </section>
