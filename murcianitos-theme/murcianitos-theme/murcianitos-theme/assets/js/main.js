(()=>{var H="../images/icononegro.webp";var m="../images/iconoblanco.webp";function A(){let c=document.querySelector(".site-header");if(!c)return;window.addEventListener("scroll",()=>{window.scrollY>50?c.classList.add("is-scrolled"):c.classList.remove("is-scrolled")},{passive:!0});let e=c.querySelector(".mobile-toggle"),t=document.body;e&&e.addEventListener("click",()=>{let a=e.querySelector(".material-symbols-outlined");c.classList.toggle("is-menu-open"),c.classList.contains("is-menu-open")?(t.style.overflow="hidden",a&&(a.textContent="close")):(t.style.overflow="",a&&(a.textContent="menu"))})}function X(){let c=window.location.pathname.toLowerCase();return`
    <header class="site-header ${c.includes("historia")||c.includes("blog")||c.includes("carta")||c.includes("pedir-ahora")||c.includes("contacto")||c.includes("faq")||c.includes("alergenos")||c.includes("privacidad")||c.includes("aviso-legal")||c.includes("cookies")||c.includes("accesibilidad")?"is-light-theme":""}">
      <div class="container header-container">
        ...
        <nav class="header-nav-left">
          <a href="./index.html" class="nav-link ${c==="/"||c.includes("index.html")?"active":""}">Inicio</a>
          <a href="./nuestra-historia.html" class="nav-link ${c.includes("historia")?"active":""}">Historia</a>
          <a href="./carta.html" class="nav-link ${c.includes("carta")?"active":""}">Carta</a>
        </nav>

        <!-- Center Logo -->
        <a href="./index.html" class="header-logo" style="z-index: 2; position: relative;">
          <img src="${m}" alt="Murcianitos" class="logo-light" />
          <img src="${H}" alt="Murcianitos" class="logo-dark" />
        </a>

        <!-- Desktop Nav Right -->
        <nav class="header-nav-right">
          <a href="./eventos.html" class="nav-link ${c.includes("eventos")?"active":""}">Eventos</a>
          <a href="./blog.html" class="nav-link ${c.includes("blog")?"active":""}">Blog</a>
  ...
  `}function C(c="dark"){let e=c==="dark"?"":`theme-${c}`,t="PASTEL DE CARNE MURCIANO",a="HONRAMOS LA TRADICI\xD3N",i="REINVENTAMOS EL SABOR",o='<span class="ticker-separator"></span>',s=Array(6).fill(`${t} ${o} ${a} ${o} ${i} ${o}`).join(" ");return`
  ...
  `}function w(){typeof gsap<"u"&&document.querySelectorAll(".ticker-track").forEach(e=>{e.querySelector(".ticker-item")&&gsap.to(e,{xPercent:-50,ease:"none",duration:80,repeat:-1})})}function $(){return typeof gsap>"u"||typeof ScrollTrigger>"u"?(console.warn("GSAP or ScrollTrigger not loaded via CDN"),!1):(gsap.registerPlugin(ScrollTrigger),!0)}function v(){if(typeof gsap>"u")return;document.querySelectorAll('[data-reveal="fade-up"]').forEach(t=>{gsap.fromTo(t,{y:50,opacity:0},{y:0,opacity:1,duration:1,ease:"power3.out",scrollTrigger:{trigger:t,start:"top 85%",toggleActions:"play none none none"}})}),document.querySelectorAll('[data-reveal="stagger"]').forEach(t=>{let a=t.querySelectorAll(".stagger-item");a.length&&gsap.fromTo(a,{y:50,opacity:0},{y:0,opacity:1,duration:.8,stagger:.1,ease:"power2.out",scrollTrigger:{trigger:t,start:"top 80%",toggleActions:"play none none none"}})})}function I(){if(typeof gsap>"u")return;document.querySelectorAll('[data-parallax="true"]').forEach(e=>{let t=e.closest(".hero-fullscreen")!==null;gsap.to(e,{yPercent:20,ease:"none",scrollTrigger:{trigger:e.parentElement,start:t?"top top":"top bottom",end:"bottom top",scrub:!0}})})}var f=class{constructor(){this.items={},this.listeners=[]}subscribe(e){this.listeners.push(e),e(this.getState())}_notify(){let e=this.getState();this.listeners.forEach(t=>t(e))}getState(){let e=Object.keys(this.items).map(i=>({id:i,...this.items[i]})),t=e.reduce((i,o)=>i+o.quantity,0),a=e.reduce((i,o)=>i+o.price*o.quantity,0);return{items:this.items,itemsArray:e,totalItems:t,totalPrice:a}}addItem(e,t,a){let i=typeof a=="string"?parseFloat(a.replace("\u20AC","").replace(",",".")):a;this.items[e]?this.items[e]={...this.items[e],quantity:this.items[e].quantity+1}:this.items[e]={title:t,price:i,quantity:1},this._notify()}removeItem(e){if(this.items[e]){if(this.items[e].quantity>1)this.items[e]={...this.items[e],quantity:this.items[e].quantity-1};else{let t={...this.items};delete t[e],this.items=t}this._notify()}}clearCart(){this.items={},this._notify()}};function D(){let c=new f,e=document.querySelectorAll(".shop-item"),t=document.querySelector(".cart-sidebar"),a=null,i=null;if(e.forEach((s,r)=>{let h=s.querySelector(".shop-item-title"),n=s.querySelector(".card-price"),g=s.querySelector(".quantity-selector span"),l=s.querySelectorAll(".qty-btn"),d="prod_"+r;s.dataset.id=d,s.dataset.title=h.innerText.trim(),s.dataset.price=n.innerText.trim(),g&&g.classList.add("qty-display"),l.length>=2&&(l[0].dataset.action="remove",l[1].dataset.action="add")}),t){let s=t.querySelector(".cart-header"),r=t.querySelector(".btn-primary"),h=t.querySelector(".trust-badges");t.innerHTML="",s&&t.appendChild(s);let n=document.createElement("div");n.id="cart-pickup-info",n.style.display="none",n.style.alignItems="center",n.style.gap="12px",n.style.fontSize="0.9rem",n.style.color="var(--text-secondary)",n.style.backgroundColor="var(--color-cream)",n.style.border="1px solid rgba(197, 160, 89, 0.3)",n.style.padding="12px 16px",n.style.borderRadius="var(--radius-md)",n.style.marginBottom="var(--space-md)",t.appendChild(n),a=document.createElement("div"),a.className="cart-items-container",a.style.display="flex",a.style.flexDirection="column",a.style.gap="var(--space-sm)",a.style.marginBottom="var(--space-lg)",t.appendChild(a),i=document.createElement("div"),i.className="cart-total",t.appendChild(i),r&&t.appendChild(r),h&&t.appendChild(h)}document.querySelector(".shop-products")?.addEventListener("click",s=>{if(s.target.classList.contains("shop-item-img")){if(window.openImagePopup){let b=s.target.style.cssText||"";window.openImagePopup(s.target.src,b)}return}let r=s.target.closest(".qty-btn");if(!r)return;let h=r.closest(".shop-item");if(!h)return;let n=h.dataset.id,g=h.dataset.title,l=h.dataset.price,d=r.dataset.action;d==="add"?c.addItem(n,g,l):d==="remove"&&c.removeItem(n)}),c.subscribe(s=>{if(e.forEach(g=>{let l=g.dataset.id,d=g.querySelector(".qty-display");d&&(d.innerText=s.items[l]?s.items[l].quantity:0)}),a&&i){if(a.innerHTML="",s.itemsArray.length===0){a.innerHTML='<div style="color: var(--text-secondary); font-size: 0.9rem; text-align: center; padding: var(--space-md) 0;">Tu cesta est\xE1 vac\xEDa</div>',i.innerHTML="<span>Total</span><span>0,00\u20AC</span>";return}s.itemsArray.forEach(l=>{let d=document.createElement("div");d.className="cart-item-mini";let b=(l.price*l.quantity).toFixed(2).replace(".",",");d.innerHTML=`
          <span>${l.quantity}x ${l.title}</span>
          <span>${b}\u20AC</span>
        `,a.appendChild(d)});let g=s.totalPrice.toFixed(2).replace(".",",");i.innerHTML=`<span>Total</span><span>${g}\u20AC</span>`}let r=document.getElementById("checkout-total-text"),h=document.getElementById("checkout-pay-btn-total"),n=document.getElementById("checkout-items-list");if(r&&h&&n){let g=s.totalPrice.toFixed(2).replace(".",",");r.innerText=g+" \u20AC",h.innerText=g+" \u20AC",n.innerHTML="",s.itemsArray.length===0?n.innerHTML='<div style="color: var(--text-secondary); font-size: 0.9rem; text-align: center; padding: var(--space-md) 0;">Tu cesta est\xE1 vac\xEDa.</div>':s.itemsArray.forEach(l=>{let d=(l.price*l.quantity).toFixed(2).replace(".",",");n.innerHTML+=`
            <div class="cart-item-mini">
              <span>${l.quantity}x ${l.title}</span>
              <span>${d}\u20AC</span>
            </div>
          `})}});let o=document.querySelectorAll(".payment-method-btn");o.forEach(s=>{s.addEventListener("click",()=>{o.forEach(r=>r.classList.remove("selected")),s.classList.add("selected")})})}var p=class{constructor(){let e={cursorBlack:!1,cursorWhite:!1,stopAnimations:!1,muteSounds:!1,dyslexiaFont:!1,legibleFont:!1,easyReading:!1,readingMode:!1,highlightTitles:!1,highlightLinks:!1,hideImages:!1,focusMask:!1,dictionary:!1,textAlign:!1,readingGuide:!1,keyboardNav:!1,smartNav:!1,descWindows:!1,screenReader:!1,zoomNav:!1,grayscale:!1,invert:!1,highContrast:!1,lowBrightness:!1,scaleText:!1,fontSize:1,letterSpacing:0,lineHeight:1.5,wordSpacing:0,contrastVal:100,saturateVal:100,brightnessVal:100,deuteranopia:!1,deuteranomalia:!1,protanopia:!1,tritanopia:!1,tritanomalia:!1,acromatopsia:!1},t=null;try{t=JSON.parse(localStorage.getItem("murcianitos_acc"))}catch{}this.state={...e,...t||{}},this.init()}init(){this.injectHTML(),this.applyState(),this.bindEvents(),this.bindMouseTrackers()}injectHTML(){let e=`
