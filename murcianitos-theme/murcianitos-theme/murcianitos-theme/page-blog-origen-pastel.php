<?php
/**
 * Template Name: Blog Origen Pastel
 */
...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Historia &bull; 10 Enero 2026</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">El origen del pastel de carne</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?q=80&w=1600&auto=format&fit=crop" alt="El origen del pastel de carne" class="post-image">
          </div>
        </div>
      </header>
      ...
      <div class="back-btn-container" data-reveal="fade-up">
        <a href="./blog.html?all=true#blog-grid" class="btn btn-secondary" style="min-width: 250px;">VOLVER AL BLOG</a>
      </div>
    </article>
