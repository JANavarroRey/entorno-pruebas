...
<main>
    ...
    <section class="section">
      <div class="container policy-layout" data-reveal="fade-up">
        ...
        <p>Puede revisar nuestra política de privacidad y protección de datos personales en el siguiente <a href="./privacidad.html" style="color: var(--color-burgundy); text-decoration: underline;">enlace</a>.</p>
