<?php
/**
 * Template Name: Blog Ediciones Limitadas
 */
...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Obrador &bull; 20 Noviembre 2025</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">Ediciones Limitadas</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1517686469429-8bdb88b9f907?q=80&w=1600&auto=format&fit=crop" alt="Ediciones Limitadas" class="post-image">
          </div>
        </div>
      </header>
