...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Ingredientes &bull; 30 Septiembre 2025</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">El arte del huevo duro</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1482049016688-2d3e1b311543?q=80&w=1600&auto=format&fit=crop" alt="El arte del huevo duro" class="post-image">
          </div>
        </div>
      </header>
