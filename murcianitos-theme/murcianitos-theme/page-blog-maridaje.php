...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Gastronomía &bull; 05 Diciembre 2025</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">El maridaje perfecto</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?q=80&w=1600&auto=format&fit=crop" alt="El maridaje perfecto" class="post-image">
          </div>
        </div>
      </header>
