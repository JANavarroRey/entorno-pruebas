<?php
/**
 * Template Name: Blog Bando Huerta
 */
...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Eventos &bull; 20 Marzo 2026</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">Murcianitos en Bando de la Huerta</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=1600&auto=format&fit=crop" alt="Murcianitos en Bando de la Huerta" class="post-image">
          </div>
        </div>
      </header>
      ...
      <div class="back-btn-container" data-reveal="fade-up">
        <a href="<?php echo home_url('/blog/'); ?>" class="btn btn-secondary" style="min-width: 250px;">VOLVER AL BLOG</a>
      </div>
    </article>
