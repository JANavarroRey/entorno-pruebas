<?php
/**
 * Template Name: Blog Chato Murciano
 */
...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Ingredientes &bull; 05 Abril 2026</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">El auténtico chato murciano</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1608889825103-eb5ed706fc64?q=80&w=1600&auto=format&fit=crop" alt="El auténtico chato murciano" class="post-image">
          </div>
        </div>
      </header>
