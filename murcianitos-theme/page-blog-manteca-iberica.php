<?php
/**
 * Template Name: Blog Manteca Iberica
 */
...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Ingredientes &bull; 15 Febrero 2026</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">La manteca ibérica perfecta</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3826.webp" alt="La manteca ibérica perfecta" class="post-image">
          </div>
        </div>
      </header>
