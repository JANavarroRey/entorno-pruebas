<?php
/**
 * Template Name: Blog Obrador Dentro
 */
...
<main>
    ...
    <article>
      <header class="post-hero">
        <div class="container">
          <div class="post-meta" data-reveal="fade-up">Obrador &bull; 14 Octubre 2025</div>
          <h1 class="post-title" data-reveal="fade-up" data-reveal-delay="100">Nuestro obrador por dentro</h1>
          <div class="post-image-container" data-reveal="fade-up" data-reveal-delay="200">
            <img src="https://images.unsplash.com/photo-1587241321921-91a834d6d191?q=80&w=1600&auto=format&fit=crop" alt="Nuestro obrador por dentro" class="post-image">
          </div>
        </div>
      </header>
