...
<main>
        ...
        <div class="products-grid" data-reveal="stagger">
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3804.webp" alt="Murcianito Clásico" class="card-image">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3798.webp" alt="Murcianito Ibérico" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3826.webp" alt="Murcianito Trufado" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Edición Cuaresma" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3804.webp" alt="Murcianito Queso de Cabra" class="card-image" style="filter: contrast(1.1);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3798.webp" alt="Murcianito Vegano" class="card-image" style="filter: saturate(1.2);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
    ...
    <section class="menu-category" id="dulces" style="background-color: var(--color-cream);">
      <div class="container">
        ...
        <div class="products-grid" data-reveal="stagger">
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Murcianito Chocolate" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Murcianito Cabello de Ángel" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Murcianito Crema" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Murcianito Pistacho" class="card-image" style="filter: hue-rotate(-30deg);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Murcianito Turrón" class="card-image" style="filter: brightness(1.1);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Murcianito Lemon Pie" class="card-image" style="filter: contrast(1.2) saturate(1.5);">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
      ...
      <div class="container">
        ...
        <div class="products-grid" data-reveal="stagger">
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pack3box.webp" alt="Pack Degustación" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pack6box.webp" alt="Pack La Cuadrilla" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
          ...
          <article class="card-product stagger-item">
            ...
            <div class="card-image-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pack12box.webp" alt="Pack El Bando" class="card-image">
              <div class="card-image-overlay"></div>
            </div>
            <div class="card-content">
    ...
    <section class="section" style="background-color: var(--color-burgundy); color: var(--color-white); text-align: center; padding: var(--space-5xl) var(--space-md);">
      <div class="container" data-reveal="fade-up">
        ...
        <a href="<?php echo home_url('/eventos/'); ?>" class="btn btn-primary" style="padding: 12px 32px; font-size: 1rem; background-color: var(--color-gold); color: var(--color-ink); border-color: var(--color-gold);">Descubrir Servicios</a>
      </div>
    </section>
    ...
    <section class="section" style="background-color: var(--color-cream); padding: var(--space-3xl) var(--space-md);">
      <div class="container" data-reveal="fade-up">
        <div style="background-color: #FFFFFF; border: 1px solid rgba(197, 160, 89, 0.3); border-radius: var(--space-md); padding: var(--space-2xl); text-align: center; max-width: 800px; margin: 0 auto; box-shadow: var(--shadow-sm); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='var(--shadow-md)';" onmouseout="this.style.transform='none'; this.style.boxShadow='var(--shadow-sm)';">
          ...
          <a href="<?php echo home_url('/alergenos/'); ?>" class="btn-link-fill">Consultar tabla completa</a>
        </div>
      </div>
    </section>
