...
<style>
    ...
    .value-icon-wrapper {
      ...
      margin: 0 auto var(--space-md); /* Centered icon for mobile */
      color: var(--color-gold);
    ...
    /* Removed value-step CSS class as it is no longer used */
...
<main>
          ...
          <div class="historia-hero-grid" style="display: grid; grid-template-columns: 1fr; gap: var(--space-4xl); align-items: center; position: relative;">
            ...
            <div class="hero-image-container" style="position: relative; display: flex; justify-content: center; align-items: center; z-index: 1;">
              <div class="papiro-parallax-wrapper" style="width: 100%; display: flex; justify-content: center;">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ordenanza-pastel-carne.webp" alt="Ordenanza Pastel de Carne" class="hero-papiro-img" style="max-width: 110%; height: auto; display: block; opacity: 0; mix-blend-mode: darken;">
              </div>
            </div>
    ...
    <section class="section" style="background-color: var(--color-burgundy); color: var(--color-white); text-align: center; padding: var(--space-5xl) var(--space-md);">
      <div class="container" data-reveal="fade-up">
        ...
        <a href="<?php echo home_url('/pedir-ahora/'); ?>" class="btn btn-primary" style="background-color: var(--color-gold); color: var(--color-ink); border-color: var(--color-gold); padding: 14px 40px; font-size: 0.9rem; letter-spacing: 0.1em; text-transform: uppercase;">Pedir ahora</a>
      </div>
    </section>
...
<script>
    // Cinematic Blur Reveal & Pure Vertical Parallax
    document.addEventListener('DOMContentLoaded', () => {
      setTimeout(() => {
        if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
          const papiro = document.querySelector('.hero-papiro-img');
          const wrapper = document.querySelector('.papiro-parallax-wrapper');
          ...
          if (papiro && wrapper) {
            ...
            // Pin the hero section and reveal the image during the scroll
            const tl = gsap.timeline({
              scrollTrigger: {
                trigger: ".hero-section",
                start: "top top",
                end: "+=600", // The user must scroll 600px before the page continues moving down
            ...
            // Reveal tied to the pinned scroll
            tl.to(papiro, {
              opacity: 1,
              y: 0,
              ease: "none"
            ...
            // Continuous vertical parallax for the wrapper (after the pin or during)
            gsap.to(wrapper, {
              scrollTrigger: {
                trigger: ".hero-section",
                start: "top top",
