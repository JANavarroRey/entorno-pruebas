...
<main style="padding-top: 140px; min-height: 70vh;">
          ...
          <div class="shop-products">
            ...
            <section id="cat-cajas" class="shop-category-section">
              ...
              <div style="display: flex; flex-direction: column; gap: var(--space-md);">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pack3box.webp" alt="Pack Degustación" class="shop-item-img" style="background-color: transparent; object-fit: contain;">
                ...
                <!-- Caja 6 -->
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pack6box.webp" alt="Pack La Cuadrilla" class="shop-item-img" style="background-color: transparent; object-fit: contain;">
                  <div class="shop-item-details">
                ...
                <!-- Caja 12 -->
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pack12box.webp" alt="Pack El Bando" class="shop-item-img" style="background-color: transparent; object-fit: contain;">
                  <div class="shop-item-details">
            ...
            <section id="cat-salados" class="shop-category-section">
              ...
              <div style="display: flex; flex-direction: column; gap: var(--space-md);">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3804.webp" alt="Clásico" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3798.webp" alt="Ibérico" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3826.webp" alt="Trufado" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Cuaresma" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3804.webp" alt="Cabra" class="shop-item-img" style="filter: contrast(1.1);">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3798.webp" alt="Vegano" class="shop-item-img" style="filter: saturate(1.2);">
                  <div class="shop-item-details">
            ...
            <section id="cat-dulces" class="shop-category-section">
              ...
              <div style="display: flex; flex-direction: column; gap: var(--space-md);">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Chocolate" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Cabello de Ángel" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Crema" class="shop-item-img">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Pistacho" class="shop-item-img" style="filter: hue-rotate(-30deg);">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Turrón" class="shop-item-img" style="filter: brightness(1.1);">
                  <div class="shop-item-details">
                ...
                <article class="shop-item">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/img3825.webp" alt="Lemon Pie" class="shop-item-img" style="filter: contrast(1.2) saturate(1.5);">
                  <div class="shop-item-details">
...
<script>
    ...
    function setActiveCat(el) {
      document.querySelectorAll('.cat-nav-link').forEach(link => link.classList.remove('active'));
    ...
    // Optional: Update active category on scroll
    ...
    function validateTakeawayForm() {
      const dateVal = document.getElementById('takeaway-date').value;
      const timeVal = document.getElementById('takeaway-time').value;
      const errorEl = document.getElementById('takeaway-error');
      ...
      if (!dateVal || !timeVal) {
        ...
        const cartInfoEl = document.getElementById('cart-pickup-info');
        const checkoutInfoEl = document.getElementById('checkout-pickup-info');
        const [y, m, d] = dateVal.split('-');
        const infoHtml = `
          <span class="material-symbols-outlined" style="font-size:24px; color: var(--color-gold);">event</span> 
          <div style="display: flex; flex-direction: column;">
            <strong style="color: var(--color-ink); font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em;">Recogida</strong>
            <span style="font-size: 0.95rem; margin-top: 2px;">${d}/${m}/${y} - ${timeVal}</span>
          </div>`;
        
        if (cartInfoEl) {
          cartInfoEl.innerHTML = infoHtml;
          cartInfoEl.style.display = 'flex';
        }
        if (checkoutInfoEl) {
          checkoutInfoEl.innerHTML = infoHtml;
          checkoutInfoEl.style.display = 'flex';
        }
    ...
    // Exponer para uso desde modulos externos
...
<script>
    function openImagePopup(src, styles) {
      const popup = document.getElementById('image-popup');
      const img = document.getElementById('popup-img');
      img.src = src;
      img.style.cssText = `max-width: 100%; max-height: 85vh; border-radius: var(--radius-lg); box-shadow: 0 10px 40px rgba(0,0,0,0.5); object-fit: contain; ${styles}`;
